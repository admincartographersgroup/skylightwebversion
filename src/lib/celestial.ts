...
// (azimuth from North, altitude above horizon) so the renderer can place them
// on the same circular "looking up" field as the aircraft. Ported unchanged
// from Skylight's shared/src/celestial.ts.

import * as AstronomyNS from "astronomy-engine";
import * as satelliteNS from "satellite.js";
import { STARS } from "./stars.js";

// Both packages ship UMD/CJS bundles. Under some bundlers the ESM namespace
// only exposes `default`, so unwrap it defensively either way.
