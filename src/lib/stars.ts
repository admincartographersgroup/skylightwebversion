// Bright-star catalog (J2000), ported unchanged from shared/src/stars.ts.
// RA in degrees, Dec in degrees, plus visual magnitude. Precession over a
// couple decades is well under a degree — fine for an ambient sky. Includes a
// few iconic asterisms for instant recognizability.
