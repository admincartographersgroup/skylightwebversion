...
// blanks — this is what makes a plain browser tab behave like a kiosk, on any
// device (Chromebook, laptop, phone, smart TV). Degrades gracefully: if Wake
// Lock or the Fullscreen API is missing (e.g. iOS Safari can't fullscreen a
// <div>), it does whatever it can and never throws. Ported unchanged from
// Skylight's web/src/lib/useAmbientMode.ts.
//
