...
// Ported unchanged from shared/src/airport.ts. SFO ships as the default; any
// other airport can be imported by ICAO/IATA code (resolved client-side from
// the OurAirports dataset — see data/airports.ts).
...
export interface Airport {
  ...
  name: string;
  /** Official name, shown in the settings drawer. */
  fullName?: string;
  lat: number;
  lon: number;
  runways: Runway[];
