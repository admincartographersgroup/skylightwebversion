// Canvas renderer — the art piece. Ported from Skylight's
// web/src/display/renderer.ts; only the TLE fetch changed (now pulled from
// the local client-side TLE cache instead of a server proxy endpoint).
//
...
import { computeSky, type Sky, type Tle } from "../lib/celestial.js";
import { ASTERISMS } from "../lib/stars.js";
import { getTles } from "../data/tle.js";
...
export class Renderer {
  ...
  /** Source health from the poller's status. */
 ...
 *  time can read ~an hour off the wall clock. */
